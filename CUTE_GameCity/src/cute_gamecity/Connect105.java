...
public class Connect105 extends Canvas{
  /*本遊戲會常用到的常數*/
  ...
  private void jbInit() throws Exception {
    this.addMouseMotionListener(new Connect105_this_mouseMotionAdapter(this));
    this.addMouseListener(new Connect105_this_mouseAdapter(this));
...
class Connect105_this_mouseAdapter extends java.awt.event.MouseAdapter {
  Connect105 adaptee;

  Connect105_this_mouseAdapter(Connect105 adaptee) {
...
class Connect105_this_mouseMotionAdapter extends java.awt.event.MouseMotionAdapter {
  Connect105 adaptee;

  Connect105_this_mouseMotionAdapter(Connect105 adaptee) {
    this.adaptee = adaptee;
  }
