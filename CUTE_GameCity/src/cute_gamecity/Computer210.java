...
public class Computer210 extends Canvas{
  /*本遊戲會常用到的常數*/
  ...
  private void jbInit() throws Exception {
    this.addMouseMotionListener(new Computer210_this_mouseMotionAdapter(this));
    this.addMouseListener(new Computer210_this_mouseAdapter(this));
...
class Computer210_this_mouseAdapter extends java.awt.event.MouseAdapter {
  Computer210 adaptee;

  Computer210_this_mouseAdapter(Computer210 adaptee) {
...
class Computer210_this_mouseMotionAdapter extends java.awt.event.MouseMotionAdapter {
  Computer210 adaptee;

  Computer210_this_mouseMotionAdapter(Computer210 adaptee) {
    this.adaptee = adaptee;
  }
